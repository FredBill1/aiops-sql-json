...
The bundled extension uses the following MIT-licensed projects:

- [dt-sql-parser](https://github.com/DTStack/dt-sql-parser), Copyright DTStack Corporation.
...
Refer to the linked upstream repositories and the dependency metadata in `package-lock.json` for complete license texts and versions.
